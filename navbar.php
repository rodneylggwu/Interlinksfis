<nav class="navbar navbar-expand-lg navbar-light bg-primary fixed-top">
        <div class="container-fluid">
          <a class="navbar-brand" href="index.php" style="color: whitesmoke;">Interlink</a>
          ...
          <div class="collapse navbar-collapse" id="navbarText">
            <ul class="navbar-nav me-auto mb-2 mb-lg-0">
              <li class="nav-item">
                <a class="nav-link" aria-current="page" href="academicadvising.php" style="color: whitesmoke;">Academic Advising</a>
              </li>
              <li class="nav-item">
              ...
              <li class="nav-item">
                <a class="nav-link" href="transportation.php" style="color: whitesmoke;">Transportation</a>
              </li>
              <li class="nav-item">
                <a class="nav-link" href="healthcare.php" style="color: whitesmoke;">HealthCare</a>
              </li>
              <li class="nav-item">
